...
class Gamebuilder extends Admin_Controller
{
    ...
    {
        if (!$this->rbac->hasPrivilege('game_results', 'can_view')) {
            access_denied();
        }
    ...
    {
        if (!$this->rbac->hasPrivilege('game_leaderboard', 'can_view')) {
            access_denied();
        }
    ...
    public function dashboard()
    {
        ...
        $data['recent_results'] = $this->gameresult_model->get(null, array_merge(
